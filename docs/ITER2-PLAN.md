...
- Comment mark (notepage-tools implements at features/comments/CommentMark.ts, exports `CommentMark`):
  ...
  `import { CommentMark } from '../comments/CommentMark'` — notepage-tools MUST export exactly that.
...
- Typecheck your workspace at the end; other agents' in-flight errors are acceptable — note them.
